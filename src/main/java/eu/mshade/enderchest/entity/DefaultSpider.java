...
public class DefaultSpider extends Spider {
    ...
    public DefaultSpider(Location location, int entityId, float health, boolean isClimbing) {
        super(location, entityId, health, isClimbing);
    }

    public DefaultSpider(Location location, int entityId) {
