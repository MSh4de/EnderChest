...
public class DefaultOcelotEntity extends Ocelot {
    ...
    public DefaultOcelotEntity(Location location, int entityId, float health, byte ocelotType, boolean isSitting, boolean isTame, String owner) {
        super(location, entityId, health, ocelotType, isSitting, isTame, owner);
    }

    public DefaultOcelotEntity(Location location, int entityId) {
