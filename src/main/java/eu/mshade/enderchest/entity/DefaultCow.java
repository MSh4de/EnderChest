...
public class DefaultCow extends Cow {
    ...
    public DefaultCow(Location location, int entityId, float health, int age) {
        super(location, entityId, health, age);
    }

    public DefaultCow(Location location, int entityId) {
