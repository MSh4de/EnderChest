...
public class DefaultCreeper extends Creeper {
    ...
    public DefaultCreeper(Location location, int entityId, float health, CreeperState creeperState, boolean isPowered) {
        super(location, entityId, health, creeperState, isPowered);
    }

    public DefaultCreeper(Location location, int entityId) {
