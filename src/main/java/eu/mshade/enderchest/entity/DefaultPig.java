...
public class DefaultPig extends Pig {
    ...
    public DefaultPig(Location location, int entityId, float health, int age, boolean isAgeLocked, boolean hasSaddle) {
        super(location, entityId, health, age, isAgeLocked, hasSaddle);
    }

    public DefaultPig(Location location, int entityId) {
