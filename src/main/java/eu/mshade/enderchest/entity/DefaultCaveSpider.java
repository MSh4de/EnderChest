...
public class DefaultCaveSpiderEntity extends CaveSpider {
    ...
    public DefaultCaveSpiderEntity(Location location, int entityId, float health, boolean isClimbing) {
