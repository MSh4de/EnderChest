...
import eu.mshade.enderchest.entity.DefaultChickenEntity;
...
public class DefaultChickenMarshal extends DefaultLivingEntityMarshal {
    ...
    public LivingEntity deserialize(BinaryTagMarshal binaryTagMarshal, Type type, BinaryTag<?> binaryTag, ParameterContainer parameterContainer) throws Exception {
        ...
        return new DefaultChickenEntity(livingEntity.getLocation(),
