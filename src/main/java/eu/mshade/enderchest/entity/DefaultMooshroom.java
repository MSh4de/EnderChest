...
public class DefaultMooshroom extends Mooshroom {

    public DefaultMooshroom(Location location, int entityId, float health) {
        super(location, entityId, health);
    }

    public DefaultMooshroom(Location location, Vector velocity, int entityId, boolean isFire, boolean isSneaking, boolean isSprinting, boolean isEating, boolean isInvisible, short airTicks, String customName, boolean isCustomNameVisible, boolean isSilent, UUID uuid, float health, int potionEffectColor, boolean isPotionEffectAmbient, byte numberOfArrowInEntity, boolean isAIDisable) {
    ...
    public DefaultMooshroom(Location location, int entityId) {
