...
public class DefaultWolf extends Wolf {
    ...
    public DefaultWolf(Location location, int entityId, float health, boolean isAngry, boolean begging, boolean collarColor, boolean isSitting, boolean isTame, String owner) {
        super(location, entityId, health, isAngry, begging, collarColor, isSitting, isTame, owner);
    }

    public DefaultWolf(Location location, int entityId) {
