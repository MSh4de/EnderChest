...
public class DefaultZombiePigman extends ZombiePigman {
    ...
    public DefaultZombiePigman(Location location, int entityId, float health, boolean isVillager, boolean isConverting, boolean isAgeLocked, int age) {
        super(location, entityId, health, isVillager, isConverting, isAgeLocked, age);
    }

    public DefaultZombiePigman(Location location, int entityId) {
