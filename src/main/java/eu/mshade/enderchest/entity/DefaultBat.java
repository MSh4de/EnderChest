...
public class DefaultBat extends Bat {
    ...
    public DefaultBat(Location location, int entityId, float health, boolean isHanging) {
        super(location, entityId, health, isHanging);
    }

    public DefaultBat(Location location, int entityId) {
