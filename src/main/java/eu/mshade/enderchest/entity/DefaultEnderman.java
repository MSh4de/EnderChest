...
public class DefaultEnderman extends Enderman {
    ...
    public DefaultEnderman(Location location, int entityId, float health, short carriedBlock, byte carriedBlockData, boolean isScreaming) {
        super(location, entityId, health, carriedBlock, carriedBlockData, isScreaming);
    }

    public DefaultEnderman(Location location, int entityId) {
