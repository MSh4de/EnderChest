...
object EntityBinaryTagMarshal {
    ...
    fun serialize(entity: Entity, metadataKeyValueBinaryTagMarshal: MetadataKeyValueBinaryTagMarshal): CompoundBinaryTag {
    ...
    fun deserialize(compoundBinaryTag: CompoundBinaryTag, metadataKeyValueBinaryTagMarshal: MetadataKeyValueBinaryTagMarshal): Entity? {
        return null
    }
}